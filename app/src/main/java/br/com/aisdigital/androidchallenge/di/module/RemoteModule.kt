...
import br.com.aisdigital.androidchallenge.remote.util.AuthInterceptor
import br.com.aisdigital.androidchallenge.remote.util.PrintingEventListener
...
open class RemoteModule {
    ...
    open fun provideOkHttp(
        builder: OkHttpClient.Builder, auth: AuthInterceptor, logging: HttpLoggingInterceptor
    ): OkHttpClient {
